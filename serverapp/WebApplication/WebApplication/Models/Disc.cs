...
namespace serverapp.Models {
    public class Disc {
        ...
        public void setDiscSigns (List<Sign> newSigns) {
            foreach (Sign sign in newSigns) {
                setSymbolSyllabe (sign.id, sign.label);
            }
        }
